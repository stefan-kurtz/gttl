...
int main(int argc, char *argv[])
{
  ...
  options.add_options()("f,file", "Input file to split",
      ...
      "n,num_parts",
      "Number of parts to split the file into (mutually exclusive with -l)",
      cxxopts::value<size_t>())(
      "l,len_parts",
      "Length of parts to split the file into (mutually exclusive with -n)",
      cxxopts::value<size_t>())(
      "o,output",
  ...
  if (result.count("num_parts") + result.count("len_parts") != 1)
  {
