...
# Checks that all files in the current git-repository are matched by a pattern in
# .gitattributes. 
# This is done by checking whether their `text` attribute was
