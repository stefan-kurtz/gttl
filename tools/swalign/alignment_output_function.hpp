    ...
    bool dna_alphabet)
{
  if (!dna_alphabet)
  {
    ...
    {
      return alignment_output<GttlSubstring<uint8_t>, GttlSubstring<uint8_t>,
                              uint8_t, encoded_matching_characters<Blosum62>,
      ...
      } else
      {
        if (score_matrix_name.is(Score_matrix_unit_score_nuc_lower))
        {
          return alignment_output<
              GttlSubstring<uint8_t>, GttlSubstring<uint8_t>, uint8_t,
